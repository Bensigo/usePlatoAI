...
- For Milestone 009 desktop companion work, use `docs/visual-evidence/milestone-009-checklist.md`; screenshots of the Vite localhost browser page are not sufficient evidence for product behavior.
